...
class ArticleTest < ActiveSupport::TestCase
  ...
  def setup
    user = User.create(username: "Akshay123", email:"akshay@example.com", password: "password")  
    @article = Article.new(title: "Rails Tutorial", description: "Ruby on Rails", user: user)
  end
